    ...
    <Container>
      <div className="mb-10">
        <div className="flex items-center justify-between">
          ...
          >
            View All Categories{" "}
            <span className="absolute bottom-0 left-0 w-full block h-[1px] bg-gray-600 -translate-x-[100%] group-hover:translate-x-0 duration-300" />   {/* the hover  */}
          </Link>
        </div>
        <div className="w-full h-[1px] bg-gray-200 mt-3" /> {/* the straight line  */}
      </div>
